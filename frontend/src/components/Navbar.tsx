...
export default function Navbar() {
    ...
    return (
        <nav className="w-full border-b-3 border-black bg-background-light sticky top-0 z-50 transition-all duration-300">
            <div className="px-4 md:px-8 py-2 flex items-center justify-between w-full gap-4 transition-all duration-300">
                {/* Logo Area */}
                <Link href="/" className="flex items-center gap-3 shrink-0 group py-1">
                    <img src="/logo.png" alt="Cultural Hatti Logo" className="h-10 md:h-12 w-auto object-contain transition-transform group-hover:scale-105 mix-blend-multiply" />
                </Link>
                {/* Desktop Links */}
                <div className="hidden md:flex items-center gap-8 lg:gap-12 flex-1 justify-center">
                    ...
                    <Link className="text-sm font-bold tracking-widest text-black hover:text-primary transition-colors uppercase border-b-2 border-transparent hover:border-primary pb-0.5" href="/category/kids">Kids</Link>
                </div>
                {/* Actions */}
                <div className="flex items-center gap-2 md:gap-4 shrink-0">
                    ...
                    <button onClick={() => {}} className="md:hidden w-10 h-10 border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-all shrink-0">
